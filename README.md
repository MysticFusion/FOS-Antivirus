...
FOS Antivirus is a modern, lightweight, and high-performance security scanner for Windows. Built using **C**, it provides a clean user interface to scan, detect, and quarantine malicious files.
...
- **Restoration:** Restore files from quarantine back to their original location.
